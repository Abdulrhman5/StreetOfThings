...
namespace Catalog.DataAccessLayer.Migrations
{
    ...
    [Migration("20200623173532_ObjectRelatedToLogin")]
    partial class ObjectRelatedToLogin
    {
            ...
            modelBuilder.Entity("Catalog.Models.ObjectComment", b =>
                {
                    ...
                    b.HasOne("Catalog.Models.OfferedObject", null)
                        .WithMany("Comments")
                        .HasForeignKey("OfferedObjectId");
                });
